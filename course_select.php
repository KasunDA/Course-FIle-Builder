...
*/
    ...
    ?>
          ...
          <button id ="myBtn1" class="mycButton" >Add Course
          </button>
          <button id ="myBtn2" class="mycButton" onclick="display()" type="button" >Delete Course
          </button>
        ...
        <form style="display:none" id="formtodelete" action="deletecourse.php" method="POST">
            ...
            <input type ="submit" id="submitdelete" class="mycButton">
        </form>
        <br>
